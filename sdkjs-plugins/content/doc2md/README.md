...
It is is compatible with [self-hosted](https://github.com/R7-Office/DocumentServer) and [desktop](https://github.com/R7-Office/DesktopEditors) versions of R7-Office editors. It can be added to R7-Office instances manually. 
