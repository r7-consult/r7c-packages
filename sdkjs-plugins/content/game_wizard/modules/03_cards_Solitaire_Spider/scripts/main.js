/**
 * @summary Main entry point for the Solitaire Klondike plugin.
...
(function() {
    ...
    function initializeGame() {
        ...
        try {
            // Create Spider game manager
            game = new SpiderManager();
            game.initialize(1); // Start with 1 suit difficulty
            game.startNewGame();
            
            // Make globally accessible for debugging
            window.spiderManager = game;
            ...
            // Add difficulty selector if available
            ...
            isInitialized = true;
            console.log('[Main] Solitaire game initialized and started.');

        } catch (error) {
            console.error('[Main] Failed to initialize Solitaire game:', error);
