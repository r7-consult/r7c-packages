 ...
 * @brief R7 Office JavaScript Macro - ApiParagraph.SetIndLeft
 * @author R7-Consult
 * @version 1.0.0
 * @date July 15, 2025
 *
 ...
 * It creates a shape, adds text to the first paragraph, sets its left indentation, and then adds another paragraph without indentation.
 *
 * @description (Russian)
 * Этот макрос демонстрирует, как установить отступ с левой стороны абзаца.
 * Он создает фигуру, добавляет текст в первый абзац, устанавливает его левый отступ, а затем добавляет еще один абзац без отступа.
 *
 * @returns {void}
 *
