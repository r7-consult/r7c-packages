 ...
 * @brief R7 Office JavaScript Macro - ApiParaPr.SetIndFirstLine
 * @author R7-Consult
 * @version 1.0.0
 * @date July 15, 2025
 *
 ...
 * It creates a shape, gets its content, sets the first line indentation of the paragraph properties, and then adds text to the paragraph.
 *
 * @description (Russian)
 * Этот макрос демонстрирует, как установить отступ первой строки абзаца.
 * Он создает фигуру, получает ее содержимое, устанавливает отступ первой строки свойств абзаца, а затем добавляет текст в абзац.
 *
 * @returns {void}
 *
