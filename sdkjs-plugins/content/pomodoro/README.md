# Pomodoro Timer Plugin for R7-Office

This plugin adds a customizable Pomodoro Timer to R7-Office, helping users improve productivity through structured focus and break intervals. With configurable focus/break times and optional white noise, this plugin offers a distraction-free environment for users working within R7-Office.
...
2. Extract the files and upload them to your R7-Office server’s plugin folder.
3. Enable the plugin in R7-Office.

## Usage

1. Open R7-Office and navigate to the plugins section.
