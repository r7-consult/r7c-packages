 ...
 * @brief R7 Office JavaScript Macro - ApiPivotField.SetName
 * @author R7-Consult
 * @version 1.0.0
 * @date July 15, 2025
 *
 * @description
 * This macro demonstrates how to set the name of a pivot field.
 * It creates a pivot table, adds fields, displays its initial name, sets a new name, and then displays the updated name.
 *
 * @description (Russian)
 * Этот макрос демонстрирует, как установить имя поля сводной таблицы.
 * Он создает сводную таблицу, добавляет поля, отображает его исходное имя, устанавливает новое имя, а затем отображает обновленное имя.
 *
 * @returns {void}
 *
