/**
 * @file GetPivotField_macroR7.js
 * @brief R7 Office JavaScript Macro - ApiPivotDataField.GetPivotField
 * @author R7-Consult
 * @version 1.0.0
 * @date July 15, 2025
 *
 * @description
 * This macro demonstrates how to get the pivot field of a data field.
 * It creates a pivot table, adds data fields, and then displays the index of the data field and its corresponding pivot field.
 *
 * @description (Russian)
 * Этот макрос демонстрирует, как получить сводное поле поля данных.
 * Он создает сводную таблицу, добавляет поля данных, а затем отображает индекс поля данных и соответствующего ему сводного поля.
 *
 * @returns {void}
 *
