/**
 * @file SetIndRight_macroR7.js
 * @brief R7 Office JavaScript Macro - ApiParagraph.SetIndRight
 * @author R7-Consult
 * @version 1.0.0
 * @date July 15, 2025
 *
 * @description
 * This macro demonstrates how to set the right side indentation of a paragraph.
 * It creates a shape, adds text to the first paragraph, sets its right indentation and justification, and then adds another paragraph without indentation.
 *
 * @description (Russian)
 * Этот макрос демонстрирует, как установить отступ с правой стороны абзаца.
 * Он создает фигуру, добавляет текст в первый абзац, устанавливает его правый отступ и выравнивание, а затем добавляет еще один абзац без отступа.
 *
 * @returns {void}
 *
