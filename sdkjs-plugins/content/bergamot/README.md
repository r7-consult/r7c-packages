# Bergamot Translator Plugin for R7-Office

An offline machine translation plugin for R7-Office editors, powered by the Bergamot neural machine translation engine.
...
1. Install the plugin in your R7-Office editor
