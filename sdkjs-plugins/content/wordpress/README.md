...
The plugin is pre-installed in R7-Office Enterprise Edition, Community Edition (Document Server + Community Server), R7-Office cloud service, and R7-Office Personal.

## How to use

In the Cloud Service and R7-Office Personal, you just need to log in to your WordPress account in the plugin within the document editor. To configure WordPress in the server solutions, you have to get the WordPress authorization key.
