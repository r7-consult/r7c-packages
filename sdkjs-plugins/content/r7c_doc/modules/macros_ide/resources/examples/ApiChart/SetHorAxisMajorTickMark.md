/**
 * @file SetHorAxisMajorTickMark_macroR7.js
 * @brief R7 Office JavaScript Macro - ApiChart.SetHorAxisMajorTickMark
 * @author R7-Consult
 * @version 1.0.0
 * @date July 15, 2025
 *
 * @description
 * This macro demonstrates how to set the major tick mark for the horizontal axis of a chart.
 * It creates a scatter chart, sets its title, and then sets the major tick mark to "cross".
 *
 * @description (Russian)
 * Этот макрос демонстрирует, как установить основную отметку для горизонтальной оси диаграммы.
 * Он создает точечную диаграмму, устанавливает ее заголовок, а затем устанавливает основную отметку на "cross".
 *
 * @returns {void}
 *
