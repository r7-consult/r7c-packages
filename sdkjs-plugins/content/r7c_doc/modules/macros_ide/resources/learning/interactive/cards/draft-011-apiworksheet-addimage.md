...
interactive:
  version: 1
  enabled: true
  lessonId: "interactive-draft-011"
  title: "Черновик: ApiWorksheet / AddImage"
  targetEditor: "cell"
  difficulty: "easy"
  task:
  ...
  source:
    ...
    examplePath: "modules/macros_ide/resources/learning/examples-macros/ApiWorksheet/AddImage.md"
  draft: true
---
# Теория
Черновая карточка создана автоматически на базе примера `ApiWorksheet/AddImage`.
