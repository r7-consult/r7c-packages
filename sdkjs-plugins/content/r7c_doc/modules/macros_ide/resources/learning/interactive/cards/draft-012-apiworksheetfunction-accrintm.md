...
interactive:
  version: 1
  enabled: true
  lessonId: "interactive-draft-012"
  title: "Черновик: ApiWorksheetFunction / ACCRINTM"
  targetEditor: "cell"
  difficulty: "easy"
  task:
  ...
  source:
    ...
    examplePath: "modules/macros_ide/resources/learning/examples-macros/ApiWorksheetFunction/ACCRINTM.md"
  draft: true
---
# Теория
Черновая карточка создана автоматически на базе примера `ApiWorksheetFunction/ACCRINTM`.
