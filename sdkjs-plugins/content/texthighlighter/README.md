...
If you need more details about how to use or develop plugins for R7-Office, please refer to the [R7-Office Plugin Documentation](https://api.R7-Office.com/docspace/plugins-sdk/get-started).
