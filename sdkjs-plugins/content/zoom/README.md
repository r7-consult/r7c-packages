...
It is compatible with [self-hosted](https://github.com/R7-Office/DocumentServer) version of R7-Office editors. It can be added to R7-Office instances manually.
