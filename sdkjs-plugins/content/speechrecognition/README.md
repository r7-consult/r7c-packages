...
Type with your voice in R7-Office Docs.

The plugin uses [Web Speech API](https://developer.mozilla.org/en-US/docs/Web/API/Web_Speech_API).

The plugin can be installed manually to the [self-hosted](https://github.com/R7-Office/DocumentServer) version of R7-Office Docs.
