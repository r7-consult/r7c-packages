 ...
 * @brief R7 Office JavaScript Macro - ApiOleObject.GetClassType
 * @author R7-Consult
 * @version 1.0.0
 * @date July 15, 2025
 *
 * @description
 * This macro demonstrates how to get the class type of an ApiOleObject.
 * It adds an OLE object to the worksheet and then displays its class type.
 *
 * @description (Russian)
 * Этот макрос демонстрирует, как получить тип класса объекта ApiOleObject.
 * Он добавляет объект OLE на лист, а затем отображает его тип класса.
 *
 * @returns {void}
 *
