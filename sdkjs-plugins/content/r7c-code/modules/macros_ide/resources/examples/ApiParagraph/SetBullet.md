 ...
 * @brief R7 Office JavaScript Macro - ApiParagraph.SetBullet
 * @author R7-Consult
 * @version 1.0.0
 * @date July 15, 2025
 *
 ...
 * It creates a shape, gets its content, creates a bullet with a dash, and then sets the bullet to the first paragraph.
 *
 * @description (Russian)
 * Этот макрос демонстрирует, как установить маркер для абзаца.
 * Он создает фигуру, получает ее содержимое, создает маркер с тире, а затем устанавливает маркер для первого абзаца.
 *
 * @returns {void}
 *
