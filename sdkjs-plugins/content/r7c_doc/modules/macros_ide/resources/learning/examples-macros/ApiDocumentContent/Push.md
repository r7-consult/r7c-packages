/**
 * @file Push_macroR7.js
 * @brief R7 Office JavaScript Macro - ApiDocumentContent.Push
 * @author R7-Consult
 * @version 1.0.0
 * @date July 15, 2025
 *
 * @description
 * This macro demonstrates how to push a paragraph to the document content within a shape.
 * It creates a shape, removes all existing elements from its content, creates a new paragraph with text,
 * and then pushes this paragraph to the shape's content.
 *
 * @description (Russian)
