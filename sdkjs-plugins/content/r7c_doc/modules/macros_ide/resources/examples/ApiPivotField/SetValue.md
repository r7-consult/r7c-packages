 ...
 * @brief R7 Office JavaScript Macro - ApiPivotField.SetValue
 * @author R7-Consult
 * @version 1.0.0
 * @date July 15, 2025
 *
 * @description
 * This macro demonstrates how to set the value of a pivot field.
 * It creates a pivot table, adds fields, displays its initial value, sets a new value, and then displays the updated value.
 *
 * @description (Russian)
 * Этот макрос демонстрирует, как установить значение поля сводной таблицы.
 * Он создает сводную таблицу, добавляет поля, отображает его исходное значение, устанавливает новое значение, а затем отображает обновленное значение.
 *
 * @returns {void}
 *
