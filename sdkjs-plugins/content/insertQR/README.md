...
If you need more information about how to use or write your own plugin, please see this [link](https://api.R7-Office.com/docs/plugin-and-macros/get-started/overview/).
