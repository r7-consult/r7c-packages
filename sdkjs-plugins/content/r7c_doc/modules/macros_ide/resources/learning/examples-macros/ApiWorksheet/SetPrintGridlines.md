/**
 * @file SetPrintGridlines_macroR7.js
 * @brief R7 Office JavaScript Macro - ApiWorksheet.SetPrintGridlines
 * @author R7-Consult
 * @version 1.0.0
 * @date July 15, 2025
 *
 * @description
 * This macro demonstrates how to specify whether the sheet gridlines must be printed or not.
 * It sets the print gridlines to true and then displays the setting.
 *
 * @description (Russian)
 * Этот макрос демонстрирует, как указать, должны ли печататься линии сетки листа.
