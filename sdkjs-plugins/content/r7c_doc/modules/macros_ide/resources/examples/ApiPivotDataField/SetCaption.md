 ...
 * @brief R7 Office JavaScript Macro - ApiPivotDataField.SetCaption
 * @author R7-Consult
 * @version 1.0.0
 * @date July 15, 2025
 *
 * @description
 * This macro demonstrates how to set a caption for a pivot data field.
 * It creates a pivot table, adds a data field, displays its initial caption, sets a new caption, and then displays the updated caption.
 *
 * @description (Russian)
 * Этот макрос демонстрирует, как установить заголовок для поля данных сводной таблицы.
 * Он создает сводную таблицу, добавляет поле данных, отображает его исходный заголовок, устанавливает новый заголовок, а затем отображает обновленный заголовок.
 *
 * @returns {void}
 *
