...
interactive:
  version: 1
  enabled: true
  lessonId: "interactive-draft-016"
  title: "Черновик: ApiWorksheetFunction / ACOS"
  targetEditor: "cell"
  difficulty: "easy"
  task:
  ...
  source:
    ...
    examplePath: "modules/macros_ide/resources/learning/examples-macros/ApiWorksheetFunction/ACOS.md"
  draft: true
---
# Теория
Черновая карточка создана автоматически на базе примера `ApiWorksheetFunction/ACOS`.
