 ...
 * @brief R7 Office JavaScript Macro - ApiChartSeries.GetClassType
 * @author R7-Consult
 * @version 1.0.0
 * @date July 15, 2025
 *
 * @description
 * This macro demonstrates how to get the class type of a chart series.
 * It creates a combo chart, gets the first series, and displays its class type in the worksheet.
 *
 * @description (Russian)
 * Этот макрос демонстрирует, как получить тип класса ряда диаграммы.
 * Он создает комбинированную диаграмму, получает первый ряд и отображает его тип класса на листе.
 *
 * @returns {void}
 *
