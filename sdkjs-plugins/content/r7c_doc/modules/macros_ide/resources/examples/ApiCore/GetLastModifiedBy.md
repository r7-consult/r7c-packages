/**
 * @file GetLastModifiedBy_macroR7.js
 * @brief R7 Office JavaScript Macro - ApiCore.GetLastModifiedBy
 * @author R7-Consult
 * @version 1.0.0
 * @date July 15, 2025
 *
 * @description
 * This macro demonstrates how to get the name of the last user who modified the current workbook.
 * It sets the last modified user for the workbook and then displays it in a shape on the worksheet.
 *
 * @description (Russian)
 * Этот макрос демонстрирует, как получить имя последнего пользователя, изменившего текущую рабочую книгу.
