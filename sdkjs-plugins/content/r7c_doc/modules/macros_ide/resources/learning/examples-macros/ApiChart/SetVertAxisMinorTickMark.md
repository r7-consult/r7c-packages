/**
 * @file SetVertAxisMinorTickMark_macroR7.js
 * @brief R7 Office JavaScript Macro - ApiChart.SetVertAxisMinorTickMark
 * @author R7-Consult
 * @version 1.0.0
 * @date July 15, 2025
 *
 * @description
 * This macro demonstrates how to set the minor tick mark for the vertical axis of a chart.
 * It creates a scatter chart, sets its title, and then sets the minor tick mark to "out".
 *
 * @description (Russian)
 * Этот макрос демонстрирует, как установить второстепенную отметку для вертикальной оси диаграммы.
