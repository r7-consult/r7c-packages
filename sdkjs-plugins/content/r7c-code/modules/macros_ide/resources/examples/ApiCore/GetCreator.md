/**
 * @file GetCreator_macroR7.js
 * @brief R7 Office JavaScript Macro - ApiCore.GetCreator
 * @author R7-Consult
 * @version 1.0.0
 * @date July 15, 2025
 *
 * @description
 * This macro demonstrates how to get the creator of the current workbook using the ApiCore.
 * It sets a creator for the workbook and then displays it in a shape on the worksheet.
 *
 * @description (Russian)
 * Этот макрос демонстрирует, как получить создателя текущей рабочей книги с помощью ApiCore.
