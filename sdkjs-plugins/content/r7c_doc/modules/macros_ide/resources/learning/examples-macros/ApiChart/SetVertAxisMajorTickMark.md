/**
 * @file SetVertAxisMajorTickMark_macroR7.js
 * @brief R7 Office JavaScript Macro - ApiChart.SetVertAxisMajorTickMark
 * @author R7-Consult
 * @version 1.0.0
 * @date July 15, 2025
 *
 * @description
 * This macro demonstrates how to set the major tick mark for the vertical axis of a chart.
 * It creates a scatter chart, sets its title, and then sets the major tick mark to "cross".
 *
 * @description (Russian)
 * Этот макрос демонстрирует, как установить основную отметку для вертикальной оси диаграммы.
