# Mathpix Plugin for R7-Office

Convert mathematical formulas from images to editable text! This plugin allows you to easily extract mathematical formulas and text from images and insert them directly into your R7-Office documents.
...
#### Important Notes
- **When using LaTeX format, some complex mathematical expressions may need manual adjustment to work with R7-Office Document Editor**
...
- Contact R7-Office support team
