 ...
 * @brief R7 Office JavaScript Macro - ApiPivotItem.GetName
 * @author R7-Consult
 * @version 1.0.0
 * @date July 15, 2025
 *
 * @description
 * This macro demonstrates how to get the name of a pivot item.
 * It creates a pivot table, adds fields, and then displays the names of the pivot items for the 'Style' pivot field.
 *
 * @description (Russian)
 * Этот макрос демонстрирует, как получить имя элемента сводной таблицы.
 * Он создает сводную таблицу, добавляет поля, а затем отображает имена элементов сводной таблицы для поля сводной таблицы «Стиль».
 *
 * @returns {void}
 *
