/**
 * @file BINOM_DIST_macroR7.js
 * @brief R7 Office JavaScript Macro - ApiWorksheetFunction.BINOM_DIST
 * @author R7-Consult
 * @version 1.0.0
 * @date July 15, 2025
 *
 * @description
 * This macro demonstrates how to return the individual term binomial distribution probability using ApiWorksheetFunction.BINOM_DIST.
 * It calculates the binomial distribution probability for specified parameters and displays the result in cell A1.
 *
 * @description (Russian)
 * Этот макрос демонстрирует, как вернуть вероятность биномиального распределения отдельного члена с помощью ApiWorksheetFunction.BINOM_DIST.
